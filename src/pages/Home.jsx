...
const Home = ({ usuario, esAdmin }) => {
  ...
  return (
    <div className={`contenedor-pastel ${fadeIn ? 'fade-in' : ''}`} style={{ backgroundColor: fondo }}>
      ...
      <div className="carrusel">
        <img src={imagenes[index]} alt={`Torta ${index + 1}`} className="imagen-carrusel" />
      ...
      {esAdmin && (
        <div className="opcionesAdmin">
          ...
          <p>Accediste como <strong>admin</strong>. Puedes gestionar pedidos, envíos y tortas personalizadas.</p>
        </div>
      )}
      ...
      <footer className="ms-footer">
        ...
        <p className="ms-footer-text">
          © 2023 Pastelería Mil Sabores — Proyecto desarrollado por <span className="ms-nombre">Nicolás Parada</span> <span className="ms-nombre">Ana Pasarín</span>
        </p>
      </footer>
    </div>
  );
